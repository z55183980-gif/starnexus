...
IMAGE_PLAYGROUND_DIR = ./web/gpt-image-playground
BACKEND_DIR = .
...
.PHONY: all build-image-playground build-frontend build-frontend-classic build-all-frontends start-backend dev dev-api dev-api-rebuild dev-web dev-web-classic reset-setup

all: build-all-frontends start-backend

build-image-playground:
	@echo "Building embedded GPT Image Playground..."
	@node scripts/sync-image-playground.mjs

build-frontend: build-image-playground
