...
func resetResponsesHTTPContinuationTestCache(t *testing.T) {
	t.Helper()
	defaultResponsesHTTPContinuationCache.mu.Lock()
	defaultResponsesHTTPContinuationCache.entries = make(map[string]responsesHTTPContinuationState)
	defaultResponsesHTTPContinuationCache.mu.Unlock()
