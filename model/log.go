...
type Log struct {
	...
	UserId              int     `json:"user_id" gorm:"index;index:idx_user_id_id,priority:1;index:idx_logs_token_usage_window,priority:1"`
	CreatedAt           int64   `json:"created_at" gorm:"bigint;index:idx_created_at_id,priority:2;index:idx_created_at_type;index:idx_logs_type_created_at,priority:2;index:idx_logs_account_window,priority:3;index:idx_logs_token_usage_window,priority:4"`
	Type                int     `json:"type" gorm:"index:idx_created_at_type;index:idx_logs_type_created_at,priority:1;index:idx_logs_account_window,priority:1;index:idx_logs_token_usage_window,priority:3"`
	...
	TokenId             int     `json:"token_id" gorm:"default:0;index;index:idx_logs_token_usage_window,priority:2"`
