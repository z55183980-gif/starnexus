...
func migrateDB() error {
	...
	models := []interface{}{
		...
		&ZQBAPIAsset{},
		&DoubaoVideo2Asset{},
		&DoubaoVideo2UserAssetGroup{},
		&DoubaoVideo2UserAsset{},
		&DoubaoVideo2UserMedia{},
		&DoubaoVideo2AccessKey{},
		&Model{},
		&Vendor{},
		&PrefillGroup{},
		&Setup{},
	...
	if common.UsingSQLite {
		...
		if err := repairAffiliateSchemaSQLite(); err != nil {
			return err
		}
	} else {
		if err := RepairAffiliateColumnNames(); err != nil {
			return err
		}
	}
	if err := BackfillUserAffiliatesFromUsers(); err != nil {
		common.SysLog("affiliate backfill warning: " + err.Error())
	}
	BackfillMissedAffiliateRebates()
	if common.UsingSQLite {
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Token{}, "Token"},
		{&User{}, "User"},
		{&UserAPIAccessEvent{}, "UserAPIAccessEvent"},
		...
		{&ContentModerationKeyUsage{}, "ContentModerationKeyUsage"},
		...
		{&DoubaoVideo2UserAssetGroup{}, "DoubaoVideo2UserAssetGroup"},
		{&DoubaoVideo2UserAsset{}, "DoubaoVideo2UserAsset"},
		{&DoubaoVideo2UserMedia{}, "DoubaoVideo2UserMedia"},
		{&DoubaoVideo2AccessKey{}, "DoubaoVideo2AccessKey"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
	...
	if !common.UsingSQLite {
		migrations = append(migrations,
			...
			struct {
				model interface{}
				name  string
			}{&UserAffiliateLedger{}, "UserAffiliateLedger"},
			struct {
				model interface{}
				name  string
			}{&TopUpAffiliateAudit{}, "TopUpAffiliateAudit"},
		)
	}
...
func ensureAffiliateTablesSQLite() error {
	...
	tables := []struct {
	...
	}{
		{
			...
			create: `CREATE TABLE ` + "`user_affiliates`" + ` (
` + "`user_id`" + ` integer,
` + "`aff_code`" + ` varchar(32) NOT NULL,
` + "`inviter_id`" + ` integer,
` + "`aff_count`" + ` integer NOT NULL DEFAULT 0,
` + "`aff_quota_usd`" + ` numeric NOT NULL DEFAULT 0,
` + "`aff_frozen_quota_usd`" + ` numeric NOT NULL DEFAULT 0,
` + "`aff_history_quota_usd`" + ` numeric NOT NULL DEFAULT 0,
` + "`aff_rebate_rate_percent`" + ` numeric,
` + "`aff_code_custom`" + ` numeric NOT NULL DEFAULT 0,
` + "`created_at`" + ` datetime,
` + "`updated_at`" + ` datetime,
PRIMARY KEY (` + "`user_id`" + `)
)`,
			columns: []sqliteColumnDef{
				...
				{Name: "aff_code", DDL: "`aff_code` varchar(32) NOT NULL"},
				{Name: "inviter_id", DDL: "`inviter_id` integer"},
				{Name: "aff_count", DDL: "`aff_count` integer NOT NULL DEFAULT 0"},
				{Name: "aff_quota_usd", DDL: "`aff_quota_usd` numeric NOT NULL DEFAULT 0"},
				{Name: "aff_frozen_quota_usd", DDL: "`aff_frozen_quota_usd` numeric NOT NULL DEFAULT 0"},
				{Name: "aff_history_quota_usd", DDL: "`aff_history_quota_usd` numeric NOT NULL DEFAULT 0"},
				{Name: "aff_rebate_rate_percent", DDL: "`aff_rebate_rate_percent` numeric"},
				{Name: "aff_code_custom", DDL: "`aff_code_custom` numeric NOT NULL DEFAULT 0"},
				{Name: "created_at", DDL: "`created_at` datetime"},
				{Name: "updated_at", DDL: "`updated_at` datetime"},
			},
			indexes: []string{
				"CREATE UNIQUE INDEX IF NOT EXISTS `idx_user_affiliates_aff_code` ON `user_affiliates`(`aff_code`)",
				"CREATE INDEX IF NOT EXISTS `idx_user_affiliates_inviter_id` ON `user_affiliates`(`inviter_id`)",
			},
		},
		{
			name: "user_affiliate_ledger",
			create: `CREATE TABLE ` + "`user_affiliate_ledger`" + ` (
` + "`id`" + ` integer,
` + "`user_id`" + ` integer NOT NULL,
` + "`action`" + ` varchar(32) NOT NULL,
` + "`amount_usd`" + ` numeric NOT NULL,
` + "`source_user_id`" + ` integer,
` + "`source_topup_id`" + ` integer,
` + "`frozen_until`" + ` datetime,
` + "`quota_after`" + ` integer,
` + "`aff_quota_usd_after`" + ` numeric,
` + "`aff_frozen_quota_usd_after`" + ` numeric,
` + "`aff_history_quota_usd_after`" + ` numeric,
` + "`created_at`" + ` datetime,
` + "`updated_at`" + ` datetime,
PRIMARY KEY (` + "`id`" + `)
)`,
			columns: []sqliteColumnDef{
				{Name: "id", DDL: "`id` integer"},
				{Name: "user_id", DDL: "`user_id` integer NOT NULL"},
				{Name: "action", DDL: "`action` varchar(32) NOT NULL"},
				{Name: "amount_usd", DDL: "`amount_usd` numeric NOT NULL DEFAULT 0"},
				{Name: "source_user_id", DDL: "`source_user_id` integer"},
				{Name: "source_topup_id", DDL: "`source_topup_id` integer"},
				{Name: "frozen_until", DDL: "`frozen_until` datetime"},
				{Name: "quota_after", DDL: "`quota_after` integer"},
				{Name: "aff_quota_usd_after", DDL: "`aff_quota_usd_after` numeric"},
				{Name: "aff_frozen_quota_usd_after", DDL: "`aff_frozen_quota_usd_after` numeric"},
				{Name: "aff_history_quota_usd_after", DDL: "`aff_history_quota_usd_after` numeric"},
				{Name: "created_at", DDL: "`created_at` datetime"},
				{Name: "updated_at", DDL: "`updated_at` datetime"},
			},
			indexes: []string{
				"CREATE INDEX IF NOT EXISTS `idx_user_affiliate_ledger_user_id` ON `user_affiliate_ledger`(`user_id`)",
				"CREATE INDEX IF NOT EXISTS `idx_user_affiliate_ledger_source_user_id` ON `user_affiliate_ledger`(`source_user_id`)",
				"CREATE INDEX IF NOT EXISTS `idx_user_affiliate_ledger_source_topup_id` ON `user_affiliate_ledger`(`source_topup_id`)",
			},
		},
		{
			name: "topup_affiliate_audits",
			create: `CREATE TABLE ` + "`topup_affiliate_audits`" + ` (
` + "`id`" + ` integer,
...
PRIMARY KEY (` + "`id`" + `)
			...
			columns: []sqliteColumnDef{
				{Name: "id", DDL: "`id` integer"},
				{Name: "topup_id", DDL: "`topup_id` integer NOT NULL"},
				{Name: "action", DDL: "`action` varchar(64) NOT NULL"},
				{Name: "detail", DDL: "`detail` text"},
				{Name: "created_at", DDL: "`created_at` datetime"},
			},
			indexes: []string{
				"CREATE UNIQUE INDEX IF NOT EXISTS `idx_topup_aff_action` ON `topup_affiliate_audits`(`topup_id`,`action`)",
			},
		},
	}
	for _, table := range tables {
		if err := ensureSQLiteTable(table.name, table.create, table.columns, table.indexes); err != nil {
			return err
		}
	}
	return nil
...
func repairAffiliateSchemaSQLite() error {
	if !common.UsingSQLite {
		return nil
	}
	if err := rebuildSQLiteTopUpAffiliateAudits(); err != nil {
		return err
	}
	return rebuildSQLiteUserAffiliateLedger()
}

func sqliteTableHasColumn(tableName, columnName string) bool {
	var cols []struct {
...
func rebuildSQLiteTopUpAffiliateAudits() error {
	if !sqliteTableHasColumn("topup_affiliate_audits", "top_up_id") {
		return nil
	}
	return DB.Transaction(func(tx *gorm.DB) error {
		if err := tx.Exec(`CREATE TABLE IF NOT EXISTS topup_affiliate_audits__repair (
...
created_at datetime
		...
		if err := tx.Exec(`INSERT INTO topup_affiliate_audits__repair (id, topup_id, action, detail, created_at)
SELECT id, COALESCE(topup_id, top_up_id), action, detail, created_at FROM topup_affiliate_audits`).Error; err != nil {
			return err
		}
		if err := tx.Exec(`DROP TABLE topup_affiliate_audits`).Error; err != nil {
			return err
		}
		if err := tx.Exec(`ALTER TABLE topup_affiliate_audits__repair RENAME TO topup_affiliate_audits`).Error; err != nil {
			return err
		}
		return tx.Exec(`CREATE UNIQUE INDEX IF NOT EXISTS idx_topup_aff_action ON topup_affiliate_audits(topup_id, action)`).Error
	})
}

func rebuildSQLiteUserAffiliateLedger() error {
	hasLegacySource := sqliteTableHasColumn("user_affiliate_ledger", "source_top_up_id")
	hasLegacyFrozen := sqliteTableHasColumn("user_affiliate_ledger", "aff_frozen_usd_after")
	hasLegacyHistory := sqliteTableHasColumn("user_affiliate_ledger", "aff_history_usd_after")
	if !hasLegacySource && !hasLegacyFrozen && !hasLegacyHistory {
		return nil
	}
	return DB.Transaction(func(tx *gorm.DB) error {
		if err := tx.Exec(`CREATE TABLE IF NOT EXISTS user_affiliate_ledger__repair (
id integer PRIMARY KEY AUTOINCREMENT,
user_id integer NOT NULL,
action varchar(32) NOT NULL,
amount_usd numeric NOT NULL,
...
updated_at datetime
		...
		if err := tx.Exec(`INSERT INTO user_affiliate_ledger__repair (
id, user_id, action, amount_usd, source_user_id, source_topup_id, frozen_until,
quota_after, aff_quota_usd_after, aff_frozen_quota_usd_after, aff_history_quota_usd_after,
created_at, updated_at
)
SELECT
id, user_id, action, amount_usd, source_user_id,
COALESCE(source_topup_id, source_top_up_id), frozen_until, quota_after, aff_quota_usd_after,
COALESCE(aff_frozen_quota_usd_after, aff_frozen_usd_after),
COALESCE(aff_history_quota_usd_after, aff_history_usd_after),
created_at, updated_at
FROM user_affiliate_ledger`).Error; err != nil {
			return err
		}
		if err := tx.Exec(`DROP TABLE user_affiliate_ledger`).Error; err != nil {
			return err
		}
		if err := tx.Exec(`ALTER TABLE user_affiliate_ledger__repair RENAME TO user_affiliate_ledger`).Error; err != nil {
			return err
		}
...
func ensureSQLiteTable(tableName string, createSQL string, required []sqliteColumnDef, indexes []string) error {
