...
func Register(c *gin.Context) {
	...
	if affCode != "" {
		if err := model.BindAffiliateInviterByCode(insertedUser.Id, affCode); err != nil {
			common.SysLog(fmt.Sprintf("affiliate bind on register failed user_id=%d aff=%s err=%v", insertedUser.Id, affCode, err))
		}
	}
	// 生成默认令牌
