...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  '/image-workbench': { section: 'imageWorkbench', module: 'workbench' },
  ...
  '/topup-records': { section: 'admin', module: 'topupRecords' },
  '/affiliate-records': { section: 'admin', module: 'affiliateRecords' },
