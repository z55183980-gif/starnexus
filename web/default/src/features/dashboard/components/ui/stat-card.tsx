...
const TONE_CLASSES: Record<StatCardTone, string> = {
  'accent-1':
    'from-overview-accent-1/80 via-overview-accent-1/45 to-overview-accent-1/5',
  'accent-2':
    'from-overview-accent-2/80 via-overview-accent-2/45 to-overview-accent-2/5',
  'accent-3':
    'from-overview-accent-3/80 via-overview-accent-3/45 to-overview-accent-3/5',
}
      ...
      <div className='flex items-start justify-between gap-1'>
        <div className='text-muted-foreground flex items-center gap-1 text-[11px] font-medium sm:gap-2 sm:text-xs'>
          <IconBadge
            ...
            className={cn(
              props.compactMobile &&
                'size-4 rounded-sm sm:size-7 sm:rounded-md [&>svg]:size-2.5 sm:[&>svg]:size-3.5'
            )}
          >
            <Icon />
          </IconBadge>
