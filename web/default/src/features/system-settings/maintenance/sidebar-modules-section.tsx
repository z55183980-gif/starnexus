...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    imageWorkbench: {
      title: t('Image Workbench area'),
      description: t('Standalone image generation workspace for end users.'),
    },
    chat: {
      title: t('Chat area'),
  ...
  > = {
    ...
    personal: {
      ...
      affiliate: {
        ...
        description: t('Invite friends and earn USD rebates on their top-ups.'),
      },
      personal: {
        title: t('Profile'),
    ...
    admin: {
      ...
      topupRecords: {
        ...
        description: t(
          'View and manage all user top-up orders and payment status'
        ),
      },
      affiliateRecords: {
        title: t('Affiliate Rebate Records'),
        description: t('Audit trail for USD referral rebates and transfers.'),
      },
      user: {
        title: t('Users'),
