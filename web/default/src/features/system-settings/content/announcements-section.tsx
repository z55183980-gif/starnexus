...
const announcementSchema = z.object({
  ...
  target: z.enum(['dashboard', 'login', 'both']),
  extra: z
    .string()
...
const targetOptions = [
  ...
  },
  {
    value: 'login',
    label: 'Login popup',
    badgeLabel: 'Login popup',
    badgeVariant: 'info' as const,
  },
  {
    value: 'both',
    label: 'Dashboard and login popup',
    badgeLabel: 'Both',
    badgeVariant: 'success' as const,
  },
]
...
export function AnnouncementsSection({
  ...
  const handleEdit = (announcement: Announcement) => {
    ...
    form.reset({
      ...
      target: announcement.target || 'dashboard',
                    ...
                    <TableCell>
                      <StatusBadge
                        label={t(
                          targetOptions.find(
                            (opt) =>
                              opt.value === (announcement.target || 'dashboard')
                          )?.badgeLabel || 'Dashboard'
                        )}
                        variant={
                          targetOptions.find(
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t('Select announcement placement')}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent alignItemWithTrigger={false}>
                    ...
                    <FormDescription>
                      {t('Choose where this announcement appears')}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
