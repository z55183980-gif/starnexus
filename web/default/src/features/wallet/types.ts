...
export type UsdtPaymentResponse = ApiResponse<{
  pay_link?: string
  url?: string
...
export interface PaymentMethod {
  ...
  icon?: string
  /** Optional backend toggle for channel visibility */
  enabled?: boolean | string
  /** Optional short tag shown on payment button */
  tag?: string
}
