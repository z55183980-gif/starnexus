...
export type DataTableToolbarProps<TData> = {
  ...
  /**
   * Always-visible second filter row (e.g. extended log filters).
   * Rendered below the primary row when `leftActions` is provided.
   */
...
export function DataTableToolbar<TData>(props: DataTableToolbarProps<TData>) {
  ...
  const hasSecondarySearch = props.secondarySearch != null
