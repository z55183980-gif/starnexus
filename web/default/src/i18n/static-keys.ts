...
export const STATIC_I18N_KEYS = [
  ...
  'Home',
  'StarNexus',
  'Direct Access API for Global AI Models',
  'Console',
  'Model Square',
  'Rankings',
  'Docs',
  ...
  'Reset to Default',
  'Referral Program',
  'Invite friends and earn USD rebates on their top-ups.',
  'Affiliate Rebate Records',
  'Audit trail for USD referral rebates and transfers.',
  'Affiliate Rebate (USD)',
  'Configure recharge-based referral rebates in USD. Registration signup rewards (QuotaForInviter/Invitee) remain in Quota Settings.',
  'Rebate accrual',
  'Transfer to balance',
  ...
  'Open support',
  'Close support',
  'StarNexus · Online support',
  '7×24 hour round-the-clock online customer service',
  'Online support',
  'WhatsApp',
  'Contact site owner',
] as const
