...
COPY ./web/default .
COPY ./VERSION .
COPY --from=builder-image-playground /build/dist ./public/image-playground
RUN DISABLE_ESLINT_PLUGIN='true' VITE_REACT_APP_VERSION=$(cat VERSION) bun x rsbuild build
